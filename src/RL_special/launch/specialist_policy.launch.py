...
PROFILE_DEFAULTS = {
    'rear': {
        ...
        'docking_state_topic': '/docking_state',
        ...
        'near_target_angular_speed_limit_rad_s': 0.05,
        ...
        'linear_odometry_scale': 1.01,
        'angular_odometry_scale': 1.02,
    },
    'front': {
        'model_file': 'front_specialist_policy.onnx',
        'docking_target_topic': '/front/docking_target',
        ...
        'rl_docking_done_topic': '/front/rl_docking_done',
...
def _build_policy_node(context):
    ...
    params = {
        ...
        'docking_state_topic': _resolve_arg(
            context,
            'docking_state_topic',
            profile['docking_state_topic'],
        ),
        ...
        'robot_docking_completion_topic': _resolve_arg(
            ...
            profile.get('robot_docking_completion_topic', ''),
        ),
        ...
        'rl_docking_done_topic': _resolve_arg(
            context,
            'rl_docking_done_topic',
            profile['rl_docking_done_topic'],
        ),
        ...
        'robot_docking_target_xy_stop_tolerance_m': _parse_float(
            _resolve_arg(
                ...
                profile.get('robot_docking_target_xy_stop_tolerance_m', 0.0),
            ),
            'robot_docking_target_xy_stop_tolerance_m',
        ),
        'robot_docking_target_yaw_stop_tolerance_deg': _parse_float(
            _resolve_arg(
                ...
                profile.get('robot_docking_target_yaw_stop_tolerance_deg', 0.0),
            ),
            'robot_docking_target_yaw_stop_tolerance_deg',
        ),
        ...
        'front_calibration_safe_axis_x_m': _parse_float(
            _resolve_arg(
                ...
                profile.get('front_calibration_safe_axis_x_m', 0.0),
            ),
            'front_calibration_safe_axis_x_m',
        ),
        ...
        'robot_docking_final_distance_m': _parse_float(
            _resolve_arg(
                ...
                profile.get('robot_docking_final_distance_m', 0.0),
            ),
            'robot_docking_final_distance_m',
        ),
        ...
        'robot_docking_final_linear_speed_m_s': _parse_float(
            _resolve_arg(
                ...
                profile.get('robot_docking_final_linear_speed_m_s', 0.0),
            ),
            'robot_docking_final_linear_speed_m_s',
        ),
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                'docking_state_topic',
                default_value='__auto__',
                description='__auto__ uses profile default docking_state topic.',
            ),
            DeclareLaunchArgument(
                'motor_state_type',
            ...
            DeclareLaunchArgument(
                'rl_docking_done_topic',
                default_value='__auto__',
                description='__auto__ uses profile default rl_docking_done topic.',
            ),
            DeclareLaunchArgument(
                'wheel_radius_m',
                default_value='__auto__',
